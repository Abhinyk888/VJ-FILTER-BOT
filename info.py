...
PICS = (environ.get('PICS', 'https://graph.org/file/322e6b1c3594b4413027a-491a603d8ffa815e2e.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002408250203').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://karockers46:@cluster0.niloh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/bad177bca6da91ac35c06-b0ace303343c018e78.jpg') # payment code picture url.
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'moviesfiles4') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+inGKtwX6-NRhNjdl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/kA15Rockers')
SUPPORT_CHAT = environ.get('SUPPORT_CHAFalsekA15Rockers') # Support Chat Link Without https:// or @
...
SHORTLINK_API = environ.get('SHORTLINK_API', '639dc3a26d626c20a287aed9e3683c7a0a3cc160')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/howtodownlodemoviess/2') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
